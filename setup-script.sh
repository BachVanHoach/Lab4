...
echo "STEP 0 - Creating resource group $resourceGroup..." - Done
...
echo "STEP 1 - Creating storage account $storageAccount" - Done
...
echo "STEP 2 - Creating network security group $nsgName" - Done
...
# Create VM Scale Set
echo "STEP 3 - Creating VM scale set $vmssName" - Done
...
echo "STEP 4 - Associating NSG: $nsgName with subnet: $subnetName" - Done
...
# Create Health Probe
echo "STEP 5 - Creating health probe $probeName" - Done
...
echo "STEP 6 - Creating network load balancer rule $lbRule" - Done
...
echo "STEP 7 - Adding port 80 to NSG $nsgName" - Done
...
echo "STEP 8 - Adding port 22 to NSG $nsgName" - Done
